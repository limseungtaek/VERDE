...
<div class="container ">
	<h1>Network <small>SERVER</small></h1>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">NETWORK 상세 목록</h4>
      </div>
      <div class="modal-body">
      <!-- ########################### modal contents start ######################## -->
      <iframe width="99.6%" height="520" src="${pageContext.request.contextPath }/modal/contents?data=net&view=server" frameborder="0" style="-ms-zoom: 1.0;"></iframe>
      <!-- ########################### modal contents end ######################## -->
      </div>
