...
<div class="container ">
	...
	<script>
		var options = {
			...
			'dataset':{
				...
				fields:['Server 01', 'Server 02', 'Server 03']
			},
			'chartDiv' : 'chart71',
			'chartType' : 'line',
			'leftOffsetValue': 40,
    ...
    <tbody>
      <tr class="success">
        ...
        <td><a data-toggle="modal" data-target="#myModal" href="#">Servername 01</a></td>
        <td>CPU</td>
        <td>장애</td>
        <td>복원</td>
        <td>SYSTEM</td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">CPU 상세 목록</h4>
      </div>
      <div class="modal-body">
      <!-- ########################### modal contents start ######################## -->
      <iframe width="99.6%" height="520" src="${pageContext.request.contextPath }/modal/contents?data=cpu&view=server" frameborder="0" style="-ms-zoom: 1.0;"></iframe>
      <!-- ########################### modal contents end ######################## -->
      </div>
