  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">HDD 상세 목록</h4>
      </div>
      <div class="modal-body">
      <!-- ########################### modal contents start ######################## -->
      <iframe width="99.6%" height="520" src="${pageContext.request.contextPath }/modal/contents?data=hdd&view=server" frameborder="0" style="-ms-zoom: 1.0;"></iframe>
      <!-- ########################### modal contents end ######################## -->
      </div>
