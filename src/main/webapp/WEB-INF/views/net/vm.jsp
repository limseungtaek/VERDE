...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <iframe width="99.6%" height="520" src="${pageContext.request.contextPath }/modal/contents?data=net&view=vm" frameborder="0" style="-ms-zoom: 1.0;"></iframe>
      <!-- ########################### modal contents end ######################## -->
      </div>
