...
<table width="650" cellspacing="0" cellpadding="0" border="0">
    ...
    <tr height="20">
        ...
        <td class="grayB" width="100">www.gurubee.net</td>
    </tr>
</table>
...
<table width="650" cellspacing="1" cellpadding="0" border="0">          
    ...
    <tr height="402">            
        <td  valign="middle" colspan="2">            
            <textarea name="contents" rows="20" cols="75">${article.contents}</textarea>
            <br><form:errors path="contents" cssClass="error" />
        </td>
    </tr>   
